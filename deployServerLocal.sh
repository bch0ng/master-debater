...
bash masterBuild.sh;
docker login;
eval "docker rm -vf \$(docker ps -a -q)";
eval "$REMOVE_ALL_DOCKER_CONTAINERS;$CREATE_NETWORK;$DEPLOY_MESSAGING; $DEPLOY_SUMMARY;$DEPLOY_DB; echo 'waiting!'; sleep 30s; $DEPLOY_GATEWAY; $DEPLOY_REDIS;"
