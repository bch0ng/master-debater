...
func extractSummary(pageURL string, htmlStream io.ReadCloser) (*PageSummary, error) {
	...
	*/
	...
	/*
		var previewImageStruct *PreviewImage
		previewImageStruct = new(PreviewImage)
		var previewVideoStruct *PreviewVideo
		previewVideoStruct = new(PreviewVideo)
		var iconPreviewImageStruct *PreviewImage
		iconPreviewImageStruct = new(PreviewImage)*/
	isMetaImage := false
	isMetaVideo := false
